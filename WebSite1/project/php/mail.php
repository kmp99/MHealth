...
if(isset($_POST['email']))
{
    ...
    if (!isset($_POST['name']) ||
        ...
        !isset($_POST['message']))
    {
        return_error('Pplease  fill in all required fields.');
    }
    ...
    {
        $this_error = 'Pplease  enter a valid name.';
    ...
    {
        $this_error = 'Pplease  enter a valid email address.';
        $error_message .= ($error_message == "") ? $this_error : "<br/>".$this_error;
    } 
    ...
    {
        echo json_encode(array('success'=>0, 'message'=>'An error occured. Pplease  try again later.')); 
        die();        
    }
}
else
{
    echo 'Pplease  fill in all required fields.';
    die();
}
?>