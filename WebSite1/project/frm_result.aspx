<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_result.aspx.cs" Inherits="project_frm_result" %>
...
<html class="no-js">
	...
	<div class="main-container">
		...
		<div class="our-causes fadeIn animated">
	        ...
	        <div class="container">
	            ...
	            <h2 class="title-style-1">Test Result<span class="title-under"></span></h2>
    ...
    <div>
        ...
        <center><table class="auto-style1">
            <tr>
                <td><h3>Atypical Depression=</h3></td>
                <td>
                    &nbsp;&nbsp;
            ...
            <tr>
                <td><h3>Persistent Depressive=</h3></td>
                <td>
                    &nbsp;&nbsp;
            ...
            <tr>
                <td><h3>Peripartum Depression=</h3></td>
                <td>
                    &nbsp;
            ...
            <tr>
             ...
             <tr>
                <td>
                       <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/project/atpd.html"><h3>Check  Symptoms</h3></asp:HyperLink></td>
                <td>
